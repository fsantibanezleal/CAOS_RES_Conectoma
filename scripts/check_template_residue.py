...
The archetype template ships an intentional example pipeline under `data-pipeline/pipeline/` with its own
model and
...
def main() -> int:
    ...
    print(
        "::error::template residue found: instantiation left example pipeline "
        "or placeholder text in place."
    )
